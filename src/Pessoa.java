public class Pessoa {
    ...
    private String cpf;
    private ProgramaFidelidade fidelidade;
    ...
    public Pessoa(String nome, int idade, String email, String cpf) {
        ...
        this.email = email;
        this.cpf = cpf;
        this.fidelidade = new ProgramaFidelidade(this);
    ...
    public ProgramaFidelidade getFidelidade() {
        return fidelidade;
    }
    public void setFidelidade(ProgramaFidelidade fidelidade) {
